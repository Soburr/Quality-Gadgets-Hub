...
@section('title', 'Search: ' . $query . ' — Quality Gadgets Hub')
        ...
        <div class="wrap">
            <div class="section-head section-head--banner">
                <div>
                    ...
                    <div class="sub">{{ $products->total() }} {{ \Illuminate\Support\Str::plural('product', $products->total()) }} found</div>
                </div>
                <span class="count-badge">{{ $products->total() }} results</span>
            </div>
